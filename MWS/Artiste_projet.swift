        ...
        if !afficheMain{
            ...
            VStack{
                if afficherCouleur{
                    ...
                    HStack{
                        TextField("NOM DE L'ARTISTE",text:$proposition)
            ...
            .onAppear{
                liste = commun.uniqueartiste(attributs[0].defaultpays, attributs[0].defaultniveau, attributs[0].nbtours)
